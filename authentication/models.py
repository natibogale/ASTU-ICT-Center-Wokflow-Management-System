...
class Manager(BaseUserManager):
    def create_user(self, username,email, firstName, lastName,gender,role,directorate ,team, password=None):
        if not username:
        ...
        # if not role:
        #     raise ValueError("Users need their role or their position ")
        # if not team:
    ...
    def create_superuser(self, username,email, password, gender = None, role =None, directorate = None, team = None):
...
class User(AbstractBaseUser):
    ...
    gender =  models.CharField(choices=gender,   max_length=100, verbose_name="Gender",null=True, blank=True, default='Male')
    ...
    directorate = models.CharField(max_length=500, verbose_name="Directorate", default='ICT Center', blank=True, null=True)
    role = models.ForeignKey(Roles, on_delete=models.CASCADE, default=1, null=True, blank=True, verbose_name="Role")
    # role = models.CharField(choices=titles,   max_length=100, verbose_name="Title", blank=True)
    team = models.ForeignKey(Teams, on_delete=models.CASCADE,  max_length=500, default=1, null=True, blank=True, verbose_name="Team")
